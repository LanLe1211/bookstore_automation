...
public class OrderDetailsStepDefinition extends TestBase {
	...
	public void user_see_details_name_as_country_region_as_street_as_city_as_postal_code_as_phone_as_email(
	...
	public void user_see_details_title_as_and_price_as(String title, Double price) {
		Assert.assertTrue(orderDetailsPage.isOrderedBookTitleAndPricePresented(title, price), "Not the ordered title and price");
	}
